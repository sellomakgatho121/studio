  ...
  return (
    <article className="max-w-5xl mx-auto p-4 md:p-8 lg:p-12">
      <header className="mb-10 animate-fadeIn">
        <h1 className="font-headline text-5xl md:text-6xl font-bold text-primary mb-4 leading-tight">
          {page.title}
        </h1>
        <p className="text-xl md:text-2xl text-muted-foreground leading-relaxed animate-fadeIn">{page.introduction}</p>
      </header>
